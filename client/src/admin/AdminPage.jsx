...
function AdminPage() {
  ...
  useEffect(() => {
    ...
    const details = async () => {
      const response = await axios.get("http://13.203.138.3:8000/api/v1/section/getsections")
      setSection(response.data.data)
      const userResponse = await axios.get("http://13.203.138.3:8000/api/v1/user/getUsers")
