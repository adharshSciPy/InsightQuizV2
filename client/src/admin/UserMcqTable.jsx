...
function UserMcqTable() {
    ...
    const fetchSectionData = async () => {
        try {
            ...
            const response = await axios.get(`http://3.6.173.209:8000/api/v1/user/getusermcqperfomance/${userId}/${sessionId}`);
            ...
            const questionPromises = questionDetails.map(async (item) => {
                const questionResponse = await axios.get(
                    `http://3.6.173.209:8000/api/v1/user/getsinglemcqquestion/${sectionDetails.sectionId}`,
