...
function StudentPage() {
  ...
  const handleStartQuiz = async () => {
    try {
      ...
      const response = await axios.get(`http://13.203.138.3:8000/api/v1/section/getquizsection`);
      ...
      const checkResponse = await axios.get(
        `http://13.203.138.3:8000/api/v1/user/checkuserquizsubmit/${loggedInUserId}/${sectionId}`
      );
